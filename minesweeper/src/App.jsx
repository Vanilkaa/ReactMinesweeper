...
function App() {
  ...
  function resetGame() {
    ...
    if (Number.isInteger(Number(heightInput)) && heightInput >= 3 && heightInput <= 50) setHeight(heightInput);
    if (Number.isInteger(Number(widthInput)) && widthInput >= 3 && widthInput <= 50) setWidth(widthInput);
